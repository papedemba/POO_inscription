...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="<?=$Contantes::WEB_ROOT?>template/classe/css/style.css">
</head>
<body>
    ...
    <!-- JS -->
    <script src="<?=$Contantes::WEB_ROOT?>template/classe/vendor/jquery/jquery.min.js"></script>
    <script src="<?=$Contantes::WEB_ROOT?>template/classe/js/main.js"></script>
